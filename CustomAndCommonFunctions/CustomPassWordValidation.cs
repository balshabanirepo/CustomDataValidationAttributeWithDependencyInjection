using Radio.Services.PasswordRuless.Interface;
using System;
...
namespace Radio.ViewModel.CustomValidationAttribute
{
      ...
      string CheckPasswordAgainstPasswordSettings(string password)
        {
            ...
            var passwordcomplexityrulesetttings = _passwordComplexityRuleService.First();
